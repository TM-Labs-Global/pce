                ...
                <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end">
                    ...
                    <div className="lg:col-span-6 max-w-[540px] ml-auto">
                        <p className="!text-[16px] md:!text-[20px] !text-white leading-relaxed">
                            You do not need a complete technical scope before speaking with PCE.
                            Whether the project is at an early assessment stage or already moving toward execution, share the information currently available and our team can help identify what is needed next.
                        </p>
                    </div>
